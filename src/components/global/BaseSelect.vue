<template>
  <div class="w-full space-y-2 ">
    <label for="" class="font-semibold w-full" v-if="label">{{ label }}</label>
    <div class="relative bg-white">
      <div
        class="flex justify-between items-center px-4 border py-2.5 rounded-md border-borderColor"
      ...
      >
        <div
          class="md:py-3 py-2 px-4 text-left hover:bg-blue-50 cursor-pointer font-semibold"
